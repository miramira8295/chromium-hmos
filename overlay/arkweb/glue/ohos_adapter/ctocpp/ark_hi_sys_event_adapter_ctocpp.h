...
class ArkHiSysEventAdapterCToCpp
 ...
 public:
  ...
  int Write(const ArkWebString& eventName,
            uint32_t type,
            const ArkWebString key0,
            const ArkWebString value0) override;
  ...
  int Write(const ArkWebString& eventName,
            ...
            const ArkWebString value2) override;
  ...
  int Write(const ArkWebString& eventName,
            ...
            const ArkWebString value4) override;
  ...
  int Write(const ArkWebString& eventName,
            ...
            const ArkWebString value6) override;
  ...
  int Write(const ArkWebString& eventName,
            ...
            const ArkWebString key8,
            const ArkWebString value8) override;
  ...
  int Write(const ArkWebString& eventName,
            ...
            const ArkWebString key2,
            const uint64_t value2) override;
};
