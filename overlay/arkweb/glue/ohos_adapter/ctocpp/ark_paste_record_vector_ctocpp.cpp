...
NWeb::PasteRecordVector ArkPasteRecordVectorStructToClass(
    const ArkPasteRecordVector& struct_value) {
...
ARK_WEB_NO_SANITIZE void ArkPasteRecordVectorStructRelease(
    ArkPasteRecordVector& struct_value) {
  struct_value.size = 0;
