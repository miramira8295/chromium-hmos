...
class ArkOhosAdapterHelperCToCpp
 ...
 public:
  ...
  ArkWebRefPtr<ArkBatteryMgrClientAdapter> CreateBatteryClientAdapter()
      override;

  ArkWebRefPtr<ArkNetConnectAdapter> CreateNetConnectAdapter() override;

  ArkWebRefPtr<ArkOhosWebDataBaseAdapter> GetOhosWebDataBaseAdapterInstance()
      override;
  ...
  ArkWebRefPtr<ArkOhosResourceAdapter> GetResourceAdapter(
      const ArkWebString& hapPath) override;

  ArkWebRefPtr<ArkSystemPropertiesAdapter> GetSystemPropertiesInstance()
      override;
  ...
  ArkWebRefPtr<ArkIConsumerSurfaceAdapter> CreateConsumerSurfaceAdapter()
      override;
  ...
  ArkWebRefPtr<ArkMediaCodecDecoderAdapter> CreateMediaCodecDecoderAdapter()
      override;
  ...
  ArkWebRefPtr<ArkOhosImageDecoderAdapter> CreateOhosImageDecoderAdapter()
      override;
  ...
  ArkWebRefPtr<ArkOhosNativeBufferAdapter> GetOhosNativeBufferAdapter()
      override;

  ArkWebRefPtr<ArkMigrationManagerAdapter> CreateMigrationMgrAdapter() override;

  ArkWebRefPtr<ArkAudioCodecDecoderAdapter> CreateAudioCodecDecoderAdapter()
      override;

  ArkWebRefPtr<ArkDrmAdapter> CreateDrmAdapter() override;

  ArkWebRefPtr<ArkOhosDrawingTextFontAdapter> GetOhosDrawingTextFontAdapter()
      override;

  ArkWebRefPtr<ArkOhosDrawingTextTypographyAdapter>
  GetOhosDrawingTextTypographyAdapter() override;

  ArkWebRefPtr<ArkScreenlockManagerAdapter> CreateScreenlockManagerAdapter()
      override;
