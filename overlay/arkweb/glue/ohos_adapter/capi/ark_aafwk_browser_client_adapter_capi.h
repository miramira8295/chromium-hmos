...
#ifndef ARK_AAFWK_BROWSER_CLIENT_ADAPTER_CAPI_H_
#define ARK_AAFWK_BROWSER_CLIENT_ADAPTER_CAPI_H_
#pragma once
...
typedef struct _ark_aafwk_browser_client_adapter_t {
  ...
  void*(ARK_WEB_CALLBACK* query_render_surface)(
      struct _ark_aafwk_browser_client_adapter_t* self,
      int32_t surface_id);
...
#endif  // ARK_AAFWK_BROWSER_CLIENT_ADAPTER_CAPI_H_
