...
class ArkAafwkAppMgrClientAdapterWrapper
 ...
 public:
  explicit ArkAafwkAppMgrClientAdapterWrapper(
      ArkWebRefPtr<ArkAafwkAppMgrClientAdapter>);

  int StartRenderProcess(const std::string& renderParam,
                         int32_t ipcFd,
                         int32_t sharedFd,
                         int32_t crashFd,
  ...
  void SaveBrowserConnect(
      std::shared_ptr<NWeb::AafwkBrowserHostAdapter> adapter) override;
