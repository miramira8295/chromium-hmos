...
class ArkMediaCodecEncoderAdapterWrapper
 ...
 public:
  explicit ArkMediaCodecEncoderAdapterWrapper(
      ArkWebRefPtr<ArkMediaCodecAdapter>);

  OHOS::NWeb::CodecCodeAdapter CreateVideoCodecByMime(
      const std::string mimetype) override;

  OHOS::NWeb::CodecCodeAdapter CreateVideoCodecByName(
  ...
  OHOS::NWeb::CodecCodeAdapter Configure(
  ...
  std::shared_ptr<OHOS::NWeb::ProducerSurfaceAdapter> CreateInputSurface()
      override;
