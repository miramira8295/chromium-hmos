...
static ArkPasteRecordVector ArkPasteRecordVectorClassToStruct(
    const NWeb::PasteRecordVector& class_value) {
...
void ArkPasteBoardClientAdapterWrapper::SetPasteData(
    const NWeb::PasteRecordVector& data,
    NWeb::CopyOptionMode copyOption) {
  if (!ctocpp_) {
    return;
  }
...
int32_t ArkPasteBoardClientAdapterWrapper::OpenRemoteUri(
