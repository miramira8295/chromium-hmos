...
ArkOhosImageDecoderAdapterWrapper::ArkOhosImageDecoderAdapterWrapper(
    ArkWebRefPtr<ArkOhosImageDecoderAdapter> ref)
    : ctocpp_(ref) {}

bool ArkOhosImageDecoderAdapterWrapper::ParseImageInfo(const uint8_t* data,
                                                       uint32_t size) {
