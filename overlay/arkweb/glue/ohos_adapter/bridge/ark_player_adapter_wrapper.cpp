...
int32_t ArkPlayerAdapterWrapper::SetSource(int32_t fd,
                                           int64_t offset,
                                           int64_t size) {
...
int32_t ArkPlayerAdapterWrapper::SetPlaybackSpeed(
...
int32_t ArkPlayerAdapterWrapper::SetMediaSourceHeader(
