...
int ArkHiSysEventAdapterWrapper::Write(const std::string& eventName,
                                       ArkEventType type,
                                       const std::tuple<const std::string,
                                                        const int64_t,
                                                        const std::string,
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result = ctocpp_->Write(
      ark_event_name, (uint32_t)type, ark_key1, ark_value1, ark_key2,
      ark_value2, ark_key3, ark_value3, ark_key4, ark_value4, ark_key5,
      ark_value5, ark_key6, ark_value6, ark_key7, ark_value7);
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1, ark_value1,
                     ark_key2, ark_value2, ark_key3, ark_value3, ark_key4,
                     ark_value4, ark_key5, ark_value5, ark_key6, ark_value6,
                     ark_key7, ark_value7, ark_key8, ark_value8);
...
int ArkHiSysEventAdapterWrapper::Write(const std::string& eventName,
  ...
  int result = ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1,
                              std::get<1>(data), ark_key2, std::get<3>(data));
