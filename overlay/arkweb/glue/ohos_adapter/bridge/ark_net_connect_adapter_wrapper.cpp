...
std::vector<std::string> ArkNetConnectAdapterWrapper::GetDnsServersByNetId(
    int32_t net_id) {
...
void ArkNetConnectAdapterWrapper::RegisterVpnListener(
    std::shared_ptr<OHOS::NWeb::VpnListener> cb) {
  if (CHECK_SHARED_PTR_IS_NULL(cb)) {
