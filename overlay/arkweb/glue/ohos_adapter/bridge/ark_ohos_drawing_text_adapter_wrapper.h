...
class ArkOhosDrawingTextFontAdapterWrapper
    : public OHOS::NWeb::OhosDrawingTextFontAdapter {
 public:
...
class ArkOhosDrawingTextTypographyAdapterWrapper
    : public OHOS::NWeb::OhosDrawingTextTypographyAdapter {
 public:
  ArkOhosDrawingTextTypographyAdapterWrapper(
      ArkWebRefPtr<ArkOhosDrawingTextTypographyAdapter>);

  int GetSystemFontConfigInfo(void* fontConfigInfoErrorCode,
                              void** fontConfigInfo) override;
