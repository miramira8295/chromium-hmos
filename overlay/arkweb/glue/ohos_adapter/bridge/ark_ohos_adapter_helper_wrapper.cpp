...
ArkOhosAdapterHelperWrapper::CreateOhosImageDecoderAdapter() {
  ArkWebRefPtr<ArkOhosImageDecoderAdapter> adapter =
      ctocpp_->CreateOhosImageDecoderAdapter();
...
ArkOhosAdapterHelperWrapper::GetOhosNativeBufferAdapter() {
  static ArkOhosNativeBufferAdapterWrapper instance(
      ctocpp_->GetOhosNativeBufferAdapter());
  return instance;
}
...
ArkOhosAdapterHelperWrapper::GetOhosDrawingTextFontAdapter() {
  static ArkOhosDrawingTextFontAdapterWrapper instance(
      ctocpp_->GetOhosDrawingTextFontAdapter());
  return instance;
}

NWeb::OhosDrawingTextTypographyAdapter&
ArkOhosAdapterHelperWrapper::GetOhosDrawingTextTypographyAdapter() {
  static ArkOhosDrawingTextTypographyAdapterWrapper instance(
      ctocpp_->GetOhosDrawingTextTypographyAdapter());
  return instance;
}

std::unique_ptr<NWeb::AudioCodecDecoderAdapter>
ArkOhosAdapterHelperWrapper::CreateAudioCodecDecoderAdapter() {
  ArkWebRefPtr<ArkAudioCodecDecoderAdapter> adapter =
      ctocpp_->CreateAudioCodecDecoderAdapter();
