...
ArkMigrationManagerAdapterWrapper::ArkMigrationManagerAdapterWrapper(
    ArkWebRefPtr<ArkMigrationManagerAdapter> ref)
    : ctocpp_(ref) {}
...
bool ArkMigrationManagerAdapterWrapper::SendMigrationRequest(
...
uint32_t ArkMigrationManagerAdapterWrapper::RegisterMigrationListener(
  ...
  return ctocpp_->RegisterMigrationListener(
      new ArkMigrationListenerAdapterImpl(listener));
}
}  // namespace OHOS::ArkWeb
