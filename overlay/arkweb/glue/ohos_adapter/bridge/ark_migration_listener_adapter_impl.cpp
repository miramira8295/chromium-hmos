...
void ArkMigrationListenerAdapterImpl::OnMigrationReply(
    ...
    const ArkWebInt32Vector& codeList) {
  std::vector<int32_t> errorIndexVec;
  std::vector<int32_t> codeListVec;

  errorIndexVec =
      ArkWebBasicVectorStructToClass<int32_t, ArkWebInt32Vector>(errorIndex);
  codeListVec =
      ArkWebBasicVectorStructToClass<int32_t, ArkWebInt32Vector>(codeList);
