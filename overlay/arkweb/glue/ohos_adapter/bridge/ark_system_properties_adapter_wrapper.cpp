...
void ArkSystemPropertiesAdapterWrapper::AttachSysPropObserver(
    NWeb::PropertiesKey key,
    NWeb::SystemPropertiesObserver* observer) {
...
bool ArkSystemPropertiesAdapterWrapper::IsLTPODynamicApp(
...
std::string ArkSystemPropertiesAdapterWrapper::GetStringParameter(
...
int32_t ArkSystemPropertiesAdapterWrapper::GetIntParameter(
    const std::string& key,
