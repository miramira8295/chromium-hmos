...
int32_t ArkNativeImageAdapterWrapper::GetNativeBuffer(void* windowBuffer,
                                                      void** nativeBuffer) {
  return ctocpp_->GetNativeBuffer(windowBuffer, nativeBuffer);
}

int32_t ArkNativeImageAdapterWrapper::ReleaseNativeWindowBuffer(
    void* windowBuffer,
    int fenceFd) {
  return ctocpp_->ReleaseNativeWindowBuffer(windowBuffer, fenceFd);
}

void ArkNativeImageAdapterWrapper::GetNativeWindowBufferSize(void* windowBuffer,
                                                             uint32_t* width,
                                                             uint32_t* height) {
