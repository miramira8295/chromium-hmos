...
ArkWebU16String ArkIMFTextListenerAdapterImpl::GetLeftTextOfCursor(
    int32_t number) {
...
ArkWebU16String ArkIMFTextListenerAdapterImpl::GetRightTextOfCursor(
    int32_t number) {
...
int32_t ArkIMFTextListenerAdapterImpl::SetPreviewText(
...
void ArkIMFTextListenerAdapterImpl::AutoFillWithIMFEvent(
    bool isUsername,
    bool isOtherAccount,
    bool isNewPassword,
    const ArkWebString& content) {
  real_->AutoFillWithIMFEvent(isUsername, isOtherAccount, isNewPassword,
                              ArkWebStringStructToClass(content));
}
