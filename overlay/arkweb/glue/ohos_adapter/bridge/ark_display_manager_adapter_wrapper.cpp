...
uint32_t ArkDisplayManagerAdapterWrapper::RegisterFoldStatusListener(
  ...
  return ctocpp_->RegisterFoldStatusListener(
      new ArkFoldStatusListenerAdapterImpl(listener));
}

bool ArkDisplayManagerAdapterWrapper::UnregisterFoldStatusListener(
    uint32_t id) {
  return ctocpp_->UnregisterFoldStatusListener(id);
}

std::shared_ptr<OHOS::NWeb::DisplayAdapter>
ArkDisplayManagerAdapterWrapper::GetPrimaryDisplay() {
...
std::vector<std::shared_ptr<OHOS::NWeb::DisplayAdapter>>
ArkDisplayManagerAdapterWrapper::GetAllDisplays() {
  if (!ctocpp_) {
  ...
  std::vector<std::shared_ptr<OHOS::NWeb::DisplayAdapter>> result =
      ArkDisplayAdapterVectorStructToClass(ark_vector);
