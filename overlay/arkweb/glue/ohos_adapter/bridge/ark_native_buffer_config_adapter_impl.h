...
#ifndef ARK_NATIVE_BUFFER_CONFIG_ADAPTER_IMPL_H
#define ARK_NATIVE_BUFFER_CONFIG_ADAPTER_IMPL_H
#pragma once
...
class ArkNativeBufferConfigAdapterImpl : public ArkNativeBufferConfigAdapter {
 public:
  explicit ArkNativeBufferConfigAdapterImpl(
      std::shared_ptr<OHOS::NWeb::NativeBufferConfigAdapter>);
 ...
 private:
  std::shared_ptr<OHOS::NWeb::NativeBufferConfigAdapter> real_;

  IMPLEMENT_REFCOUNTING(ArkNativeBufferConfigAdapterImpl);
};

}  // namespace OHOS::ArkWeb

#endif  // ARK_NATIVE_BUFFER_CONFIG_ADAPTER_IMPL_H
