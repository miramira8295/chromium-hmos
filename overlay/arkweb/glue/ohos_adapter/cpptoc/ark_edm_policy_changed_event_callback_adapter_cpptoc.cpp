...
ArkEdmPolicyChangedEventCallbackAdapterCppToC::
  ...
  std::call_once(flag, [] {
    ...
    funcMemberMap["RD$TWg2R92lOSAWnPk$ArQ"] = reinterpret_cast<void*>(
        ark_edm_policy_changed_event_callback_adapter_changed);
    ArkWebAdapterWebcoreBridgeHelper::GetInstance().RegisterFuncMember(
        ARK_EDM_POLICY_CHANGED_EVENT_CALLBACK_ADAPTER, funcMemberMap);
  });
}
