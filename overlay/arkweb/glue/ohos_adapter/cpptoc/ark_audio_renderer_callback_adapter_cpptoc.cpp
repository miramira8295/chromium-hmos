...
ArkAudioRendererCallbackAdapterCppToC::ArkAudioRendererCallbackAdapterCppToC() {
  ...
  std::call_once(flag, [] {
    ...
    funcMemberMap["xYxhLoz9lDlPDQkXkVxFRQ"] =
        reinterpret_cast<void*>(ark_audio_renderer_callback_adapter_on_suspend);
    funcMemberMap["T4q6JJH5fFlpJmlOfPUfKg"] =
        reinterpret_cast<void*>(ark_audio_renderer_callback_adapter_on_resume);
    ArkWebAdapterWebcoreBridgeHelper::GetInstance().RegisterFuncMember(
        ARK_AUDIO_RENDERER_CALLBACK_ADAPTER, funcMemberMap);
  });
}
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkAudioRendererCallbackAdapterCppToC,
