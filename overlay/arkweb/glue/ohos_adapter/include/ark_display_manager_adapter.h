...
class ArkDisplayManagerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual uint32_t RegisterDisplayListener(
      ArkWebRefPtr<ArkDisplayListenerAdapter> listener) = 0;
   ...
   */
  /*--ark web()--*/
  virtual uint32_t RegisterFoldStatusListener(
      ArkWebRefPtr<ArkFoldStatusListenerAdapter> listener) = 0;
