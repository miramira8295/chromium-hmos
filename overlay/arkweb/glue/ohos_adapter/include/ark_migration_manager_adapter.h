...
class ArkMigrationListenerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  /*--ark web()--*/
  virtual void OnMigrationReply(int32_t errorCode,
...
class ArkMigrationManagerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  /*--ark web()--*/
  virtual void SetMigrationParam(const ArkWebString& bundleName,
                                 const ArkWebString& abilityName,
                                 const ArkWebString& token) = 0;

  /*--ark web()--*/
  virtual bool SendMigrationRequest(const char* jsonData) = 0;

  /*--ark web()--*/
  virtual uint32_t RegisterMigrationListener(
      ArkWebRefPtr<ArkMigrationListenerAdapter> listener) = 0;
};
