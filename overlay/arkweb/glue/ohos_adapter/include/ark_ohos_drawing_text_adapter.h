...
/*--ark web(source=webview)--*/
class ArkOhosDrawingTextTypographyAdapter
 ...
 public:
  ...
  /*--ark web()--*/
  virtual int GetSystemFontConfigInfo(void* fontConfigInfoErrorCode,
                                      void** fontConfigInfo) = 0;
