...
class ArkCameraManagerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  virtual int32_t Create(
      ArkWebRefPtr<ArkCameraStatusCallbackAdapter> cameraStatusCallback) = 0;
  ...
  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkVideoCaptureRangeAdapter> GetCaptionRangeById(
      int32_t rangeId) = 0;
