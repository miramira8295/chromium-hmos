...
class ArkPlayerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  /*--ark web()--*/
  virtual int32_t SetPlayerCallback(
      ArkWebRefPtr<ArkPlayerCallbackAdapter> callbackAdapter) = 0;
  ...
  /*--ark web()--*/
  virtual int32_t SetVideoSurface(
      ArkWebRefPtr<ArkIConsumerSurfaceAdapter> cSurfaceAdapter) = 0;
  ...
  /*--ark web()--*/
  virtual int32_t SetMediaSourceHeader(const ArkWebString& url,
                                       const ArkWebStringMap& header) = 0;
};
