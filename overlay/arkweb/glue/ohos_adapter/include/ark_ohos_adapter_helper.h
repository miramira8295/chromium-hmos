...
class ArkOhosAdapterHelper : public virtual ArkWebBaseRefCounted {
 public:
   ...
   */
  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkOhosNativeBufferAdapter>
  GetOhosNativeBufferAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkMigrationManagerAdapter>
  CreateMigrationMgrAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkAudioCodecDecoderAdapter>
  CreateAudioCodecDecoderAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkDrmAdapter> CreateDrmAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkOhosDrawingTextFontAdapter>
  GetOhosDrawingTextFontAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkOhosDrawingTextTypographyAdapter>
  GetOhosDrawingTextTypographyAdapter() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkScreenlockManagerAdapter>
  CreateScreenlockManagerAdapter() = 0;
