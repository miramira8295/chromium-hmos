...
class ArkHiSysEventAdapter : public virtual ArkWebBaseRefCounted {
 public:
  /*--ark web()--*/
  virtual int Write(const ArkWebString& eventName,
                    uint32_t type,
                    const ArkWebString key0,
                    const ArkWebString value0) = 0;
