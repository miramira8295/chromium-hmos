...
/*--ark web(source=webcore)--*/
class ArkAudioOutputChangeCallbackAdapter
...
class ArkAudioRendererAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual int32_t SetAudioOutputChangeCallback(
      const ArkWebRefPtr<ArkAudioOutputChangeCallbackAdapter> callback) = 0;

  /**
   * @brief SetAudioSilentMode, when isSilentMode is true, audio_render will not
   * interrupt other andio output
   */
  /*--ark web()--*/
