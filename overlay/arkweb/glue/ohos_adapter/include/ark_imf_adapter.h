...
class ArkIMFTextListenerAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual int32_t SetPreviewText(const ArkWebU16String& text,
                                 int32_t start,
                                 int32_t end) = 0;
  ...
  /*--ark web()--*/
  virtual void AutoFillWithIMFEvent(bool isUsername,
                                    bool isOtherAccount,
                                    bool isNewPassword,
...
class ArkIMFAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual bool AttachWithRequestKeyboardReason(
  ...
  virtual void OnCursorUpdate(
      ArkWebRefPtr<ArkIMFCursorInfoAdapter> cursorInfo) = 0;

  /*--ark web()--*/
  virtual void OnSelectionChange(ArkWebU16String& text, int start, int end) = 0;

  /*--ark web()--*/
  virtual bool SendPrivateCommand(const ArkWebString& commandKey,
                                  const ArkWebString& commandValue) = 0;
};
