...
class ArkSystemPropertiesAdapter : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual ArkFrameRateSettingAdapterVector GetLTPOConfig(
      const ArkWebString& settingName) = 0;
  ...
  /*--ark web()--*/
  virtual ArkWebString GetStringParameter(const ArkWebString& key,
                                          const ArkWebString& defaultValue) = 0;

  /*--ark web()--*/
  virtual int32_t GetInitialCongestionWindowSize() = 0;

  /*--ark web()--*/
  virtual int32_t GetIntParameter(const ArkWebString& key,
