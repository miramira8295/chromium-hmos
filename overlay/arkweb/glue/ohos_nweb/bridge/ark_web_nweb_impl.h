...
class ArkWebNWebImpl : public ArkWebNWeb {
 ...
 public:
   ...
   * @param encoding: the encoding of the data This value may be null.
   */
  int LoadWithData(const ArkWebString& data,
                   const ArkWebString& mime_type,
   ...
   * @return The obtained information of the accessibility node.
   */
  ArkWebRefPtr<ArkWebAccessibilityNodeInfo> GetAccessibilityNodeInfoById(
   ...
   */
  void CallH5Function(int32_t routingId,
                      int32_t h5ObjectId,
  ...
  void SetPathAllowingUniversalAccess(const ArkWebStringVector& dirs,
                                      ...
                                      ArkWebString& errorPath) override;
   ...
   */
  /*--ark web()--*/
  void PerformAction(int64_t accessibility_id,
                     uint32_t action,
  ...
  int SetUrlTrustListWithErrMsg(const ArkWebString& urlTrustList,
                                ArkWebString& detailErrMsg) override;
  ...
  void ExecuteCreatePDFExt(
      ...
      ArkWebRefPtr<ArkWebArrayBufferValueCallback> callback) override;
  ...
  bool SendKeyboardEvent(
      ArkWebRefPtr<ArkWebKeyboardEvent> keyboardEvent) override;
   ...
   */
  /*--ark web()--*/
  bool PerformActionV2(int64_t accessibility_id,
                       uint32_t action,
                       const ArkWebStringMap& actionArguments) override;
   ...
   * rendering.
   */
  int64_t GetWebAccessibilityIdByHtmlElementId(
      const ArkWebString& htmlElementId) override;
   ...
   */
  int32_t GetBlanklessInfoWithKey(const ArkWebString& key,
                                  double* similarity,
                                  int32_t* loadingTime) override;
   ...
   * @return The error code.
   */
  int32_t SetBlanklessLoadingWithKey(const ArkWebString& key,
  ...
  void CallH5FunctionV2(int32_t routing_id,
                        int32_t h5_object_id,
                        const ArkWebString& h5_method_name,
                        const ArkWebRomValueVector& args) override;

  void PostPortMessageV2(const ArkWebString& portHandle,
                         ArkWebRefPtr<ArkWebRomValue> data) override;
  ...
  CreateWebPrintDocumentAdapterV2(const ArkWebString& job_name) override;

  /**
   * @brief Handle stylus touch press event.
   * @param stylus_touch_point_info The stylus touch point information
   * containing detailed parameters.
   ...
   * no-store.
   */
  void PrefetchPageV2(const ArkWebString& url,
