...
std::string ArkWebEngineInitArgsWrapper::GetSharedRenderProcessToken() {
  ArkWebString arkwebSharedRenderProcessToken =
      ark_web_engine_init_args_->GetSharedRenderProcessToken();
  std::string sharedRenderProcessToken =
      ArkWebStringStructToClass(arkwebSharedRenderProcessToken);
