...
void ArkWebNWebImpl::OnTouchPress(int32_t id,
                                  double x,
                                  double y,
                                  bool from_overlay) {
...
void ArkWebNWebImpl::OnTouchRelease(int32_t id,
                                    double x,
                                    double y,
                                    bool from_overlay) {
...
void ArkWebNWebImpl::OnTouchMove(int32_t id,
                                 double x,
                                 double y,
                                 bool from_overlay) {
...
void ArkWebNWebImpl::SendMouseWheelEvent(double x,
                                         double y,
                                         double delta_x,
                                         double delta_y) {
...
void ArkWebNWebImpl::SendMouseEvent(int x,
                                    int y,
                                    int button,
                                    int action,
                                    int count) {
...
bool ArkWebNWebImpl::GetFavicon(const void** data,
                                size_t& width,
                                size_t& height,
                                int& color_type,
                                int& alpha_type) {
...
void ArkWebNWebImpl::RegisterScreenLockFunction(
    int32_t window_id,
    ArkWebRefPtr<ArkWebScreenLockCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
...
void ArkWebNWebImpl::SetVirtualKeyBoardArg(int32_t width,
                                           int32_t height,
                                           double keyboard) {
...
void ArkWebNWebImpl::SetDrawRect(int32_t x,
                                 int32_t y,
                                 int32_t width,
                                 int32_t height) {
...
void* ArkWebNWebImpl::CreateWebPrintDocumentAdapter(
    const ArkWebString& job_name) {
  return nweb_nweb_->CreateWebPrintDocumentAdapter(
      ArkWebStringStructToClass(job_name));
}

ArkWebRefPtr<ArkWebPrintDocumentAdapterAdapter>
ArkWebNWebImpl::CreateWebPrintDocumentAdapterV2(const ArkWebString& job_name) {
  std::unique_ptr<OHOS::NWeb::NWebPrintDocumentAdapterAdapter> adapter =
      nweb_nweb_->CreateWebPrintDocumentAdapterV2(
          ArkWebStringStructToClass(job_name));
...
void ArkWebNWebImpl::JavaScriptOnDocumentStartByOrder(
    const ArkWebStringVectorMap& script_items,
    const ArkWebStringVector& script_items_by_order) {
  nweb_nweb_->JavaScriptOnDocumentStartByOrder(
      ArkWebStringVectorMapStructToClass(script_items),
      ArkWebStringVectorStructToClass(script_items_by_order));
}

void ArkWebNWebImpl::JavaScriptOnDocumentEndByOrder(
    const ArkWebStringVectorMap& script_items,
    const ArkWebStringVector& script_items_by_order) {
  nweb_nweb_->JavaScriptOnDocumentEndByOrder(
      ArkWebStringVectorMapStructToClass(script_items),
      ArkWebStringVectorStructToClass(script_items_by_order));
}

void ArkWebNWebImpl::JavaScriptOnHeadReadyByOrder(
    const ArkWebStringVectorMap& script_items,
    const ArkWebStringVector& script_items_by_order) {
  nweb_nweb_->JavaScriptOnHeadReadyByOrder(
      ArkWebStringVectorMapStructToClass(script_items),
      ArkWebStringVectorStructToClass(script_items_by_order));
}
...
void ArkWebNWebImpl::CallH5Function(int32_t routingId,
                                    int32_t h5ObjectId,
...
void ArkWebNWebImpl::ScrollByRefScreen(float delta_x,
                                       float delta_y,
                                       float vx,
                                       float vy) {
...
void ArkWebNWebImpl::OnTouchCancelById(int32_t id,
                                       double x,
                                       double y,
                                       bool from_overlay) {
...
int ArkWebNWebImpl::ScaleGestureChange(double scale,
                                       double centerX,
                                       double centerY) {
  return nweb_nweb_->ScaleGestureChange(scale, centerX, centerY);
}

void ArkWebNWebImpl::InjectOfflineResource(
    const ArkWebString& url,
  ...
  nweb_nweb_->InjectOfflineResource(
      ArkWebStringStructToClass(url), ArkWebStringStructToClass(origin),
...
void ArkWebNWebImpl::SendTouchpadFlingEvent(double x,
                                            double y,
                                            double vx,
                                            double vy) {
...
bool ArkWebNWebImpl::WebSendKeyEvent(int32_t key_code,
                                     int32_t key_action,
                                     const ArkWebInt32Vector& pressedCodes) {
  return nweb_nweb_->WebSendKeyEvent(
      key_code, key_action,
...
int ArkWebNWebImpl::SetUrlTrustListWithErrMsg(const ArkWebString& urlTrustList,
  ...
  int res = nweb_nweb_->SetUrlTrustListWithErrMsg(
      ArkWebStringStructToClass(urlTrustList), detailMsg);
...
void ArkWebNWebImpl::SetPathAllowingUniversalAccess(
    const ArkWebStringVector& dirs,
    const ArkWebStringVector& moduleName,
    ArkWebString& errorPath) {
  std::string errPath;
  nweb_nweb_->SetPathAllowingUniversalAccess(
      ArkWebStringVectorStructToClass(dirs),
      ArkWebStringVectorStructToClass(moduleName), errPath);
  errorPath = ArkWebStringClassToStruct(errPath);
}

void ArkWebNWebImpl::PerformAction(int64_t accessibility_id,
                                   uint32_t action,
                                   const ArkWebStringMap& actionArguments) {
  nweb_nweb_->PerformAction(accessibility_id, action,
                            ArkWebStringMapStructToClass(actionArguments));
}
...
void ArkWebNWebImpl::ScrollByWithAnime(float delta_x,
                                       float delta_y,
                                       int32_t duration) {
  nweb_nweb_->ScrollByWithAnime(delta_x, delta_y, duration);
}

void ArkWebNWebImpl::WebSendMouseWheelEvent(
    double x,
    double y,
    double delta_x,
    double delta_y,
    const ArkWebInt32Vector& pressedCodes) {
  nweb_nweb_->WebSendMouseWheelEvent(
      x, y, delta_x, delta_y,
      ArkWebBasicVectorStructToClass<int32_t, ArkWebInt32Vector>(pressedCodes));
}

void ArkWebNWebImpl::WebSendTouchpadFlingEvent(
    double x,
    double y,
    double vx,
    double vy,
    const ArkWebInt32Vector& pressedCodes) {
  nweb_nweb_->WebSendTouchpadFlingEvent(
      x, y, vx, vy,
      ArkWebBasicVectorStructToClass<int32_t, ArkWebInt32Vector>(pressedCodes));
}
...
void ArkWebNWebImpl::ResizeVisibleViewport(uint32_t width,
                                           uint32_t height,
                                           bool isKeyboard) {
  nweb_nweb_->ResizeVisibleViewport(width, height, isKeyboard);
}

void ArkWebNWebImpl::SetBackForwardCacheOptions(int32_t size,
                                                int32_t timeToLive) {
  nweb_nweb_->SetBackForwardCacheOptions(size, timeToLive);
}

void ArkWebNWebImpl::SetAutofillCallback(
    ArkWebRefPtr<ArkWebMessageValueCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
  ...
  nweb_nweb_->SetAutofillCallback(
      std::make_shared<ArkWebMessageValueCallbackWrapper>(callback));
}
...
void ArkWebNWebImpl::ExecuteCreatePDFExt(
    ArkWebRefPtr<ArkWebPDFConfigArgs> pdfConfig,
    ArkWebRefPtr<ArkWebArrayBufferValueCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->ExecuteCreatePDFExt(
        std::make_shared<ArkWebPDFConfigArgsWrapper>(
            CHECK_REF_PTR_IS_NULL(pdfConfig) ? nullptr : pdfConfig),
        nullptr);
    return;
  }
...
void ArkWebNWebImpl::WebSendMouseEvent(
  ...
  nweb_nweb_->WebSendMouseEvent(
      std::make_shared<ArkWebMouseEventWrapper>(mouseEvent));
}
...
int ArkWebNWebImpl::ScaleGestureChangeV2(int type,
                                         double scale,
                                         double originScale,
                                         double centerX,
                                         double centerY) {
  return nweb_nweb_->ScaleGestureChangeV2(type, scale, originScale, centerX,
                                          centerY);
}

bool ArkWebNWebImpl::SendKeyboardEvent(
    ArkWebRefPtr<ArkWebKeyboardEvent> keyboardEvent) {
  if (CHECK_REF_PTR_IS_NULL(keyboardEvent)) {
    nweb_nweb_->SendKeyboardEvent(nullptr);
    return false;
  }

  return nweb_nweb_->SendKeyboardEvent(
      std::make_shared<ArkWebKeyboardEventWrapper>(keyboardEvent));
}

bool ArkWebNWebImpl::PerformActionV2(int64_t accessibility_id,
                                     uint32_t action,
                                     const ArkWebStringMap& actionArguments) {
  return nweb_nweb_->PerformActionV2(
      accessibility_id, action, ArkWebStringMapStructToClass(actionArguments));
}
...
bool ArkWebNWebImpl::GetAccessibilityNodeRectById(int64_t accessibilityId,
                                                  int32_t* width,
                                                  int32_t* height,
                                                  int32_t* offsetX,
                                                  int32_t* offsetY) {
  return nweb_nweb_->GetAccessibilityNodeRectById(accessibilityId, width,
                                                  height, offsetX, offsetY);
}

ArkWebRefPtr<ArkWebHitTestResult> ArkWebNWebImpl::GetLastHitTestResult() {
  std::shared_ptr<OHOS::NWeb::HitTestResult> nweb_last_hit_test_result =
      nweb_nweb_->GetLastHitTestResult();
...
void ArkWebNWebImpl::SetBorderRadiusFromWeb(double borderRadiusTopLeft,
                                            double borderRadiusTopRight,
                                            double borderRadiusBottomLeft,
                                            double borderRadiusBottomRight) {
  nweb_nweb_->SetBorderRadiusFromWeb(borderRadiusTopLeft, borderRadiusTopRight,
...
void ArkWebNWebImpl::SendAccessibilityHoverEventV2(int32_t x,
                                                   int32_t y,
                                                   bool isHoverEnter) {
...
void ArkWebNWebImpl::RegisterNativeJavaScriptProxy(
  ...
  if (CHECK_REF_PTR_IS_NULL(data)) {
    nweb_nweb_->RegisterNativeJavaScriptProxy(
        ArkWebStringStructToClass(objName),
        ArkWebStringVectorStructToClass(methodName), nullptr, isAsync,
        ArkWebStringStructToClass(permission));
    return;
  }
  nweb_nweb_->RegisterNativeJavaScriptProxy(
      ...
      std::make_shared<ArkWebJsProxyMethodWrapper>(data), isAsync,
      ArkWebStringStructToClass(permission));
}
...
void ArkWebNWebImpl::SetPipNativeWindow(int delegate_id,
                                        ...
                                        void* window) {
  nweb_nweb_->SetPipNativeWindow(delegate_id, child_id, frame_routing_id,
                                 window);
}
...
void ArkWebNWebImpl::SendPipEvent(int delegate_id,
                                  ...
                                  int frame_routing_id,
                                  int event) {
  nweb_nweb_->SendPipEvent(delegate_id, child_id, frame_routing_id, event);
}
...
int64_t ArkWebNWebImpl::GetWebAccessibilityIdByHtmlElementId(
    const ArkWebString& htmlElementId) {
  return nweb_nweb_->GetWebAccessibilityIdByHtmlElementId(
      ArkWebStringStructToClass(htmlElementId));
}

int32_t ArkWebNWebImpl::GetBlanklessInfoWithKey(const ArkWebString& key,
                                                double* similarity,
                                                int32_t* loadingTime) {
  return nweb_nweb_->GetBlanklessInfoWithKey(ArkWebStringStructToClass(key),
                                             similarity, loadingTime);
}

int32_t ArkWebNWebImpl::SetBlanklessLoadingWithKey(const ArkWebString& key,
                                                   bool isStart) {
  return nweb_nweb_->SetBlanklessLoadingWithKey(ArkWebStringStructToClass(key),
                                                isStart);
}
...
void ArkWebNWebImpl::CallH5FunctionV2(int32_t routing_id,
                                      int32_t h5_object_id,
                                      const ArkWebString& h5_method_name,
                                      const ArkWebRomValueVector& args) {
  nweb_nweb_->CallH5FunctionV2(routing_id, h5_object_id,
                               ArkWebStringStructToClass(h5_method_name),
                               ArkWebRomValueVectorStructToClass(args));
}

void ArkWebNWebImpl::PostPortMessageV2(const ArkWebString& portHandle,
                                       ArkWebRefPtr<ArkWebRomValue> data) {
  if (CHECK_REF_PTR_IS_NULL(data)) {
    nweb_nweb_->PostPortMessageV2(ArkWebStringStructToClass(portHandle),
                                  nullptr);
    return;
  }

  nweb_nweb_->PostPortMessageV2(ArkWebStringStructToClass(portHandle),
                                std::make_shared<ArkWebRomValueWrapper>(data));
}
...
void ArkWebNWebImpl::OnStylusTouchPress(
    ArkWebRefPtr<ArkWebStylusTouchPointInfo> stylus_touch_point_info,
    bool from_overlay) {
...
void ArkWebNWebImpl::OnStylusTouchMove(
  ...
  nweb_nweb_->OnStylusTouchMove(
      ArkWebStylusTouchPointInfoVectorStructToClass(stylus_touch_point_infos),
      from_overlay);
}
