...
class ArkWebEngineImpl : public ArkWebEngine {
 ...
 public:
  ...
  ArkWebRefPtr<ArkWebNWeb> CreateNWeb(
      ArkWebRefPtr<ArkWebNWebCreateInfo> create_info) override;
  ...
  void PrepareForPageLoad(const ArkWebString& url,
                          bool preconnectable,
  ...
  void ClearPrefetchedResource(
      const ArkWebStringVector& cache_key_list) override;

  void WarmupServiceWorker(const ArkWebString& url) override;

  void SetHostIP(const ArkWebString& hostName,
  ...
  void SetUserAgentForHosts(const ArkWebString& userAgent,
                            const ArkWebStringVector& hosts) override;
  ...
  ArkWebString CheckBlankOptEnable(const ArkWebString& url,
