...
ArkWebString ArkWebAccessibilityNodeInfoImpl::GetAccessibilityLevel() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetAccessibilityLevel());
}
...
ArkWebString ArkWebAccessibilityNodeInfoImpl::GetAccessibilityText() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetAccessibilityText());
}

ArkWebString ArkWebAccessibilityNodeInfoImpl::GetComponentTypeDescription() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetComponentTypeDescription());
}
...
ArkWebString ArkWebAccessibilityNodeInfoImpl::GetExpandedState() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetExpandedState());
}

ArkWebString ArkWebAccessibilityNodeInfoImpl::GetHtmlElementId() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetHtmlElementId());
}
}  // namespace OHOS::ArkWeb
