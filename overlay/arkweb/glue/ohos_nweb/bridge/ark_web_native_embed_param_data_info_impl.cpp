...
ArkWebNativeEmbedParamDataInfoImpl::ArkWebNativeEmbedParamDataInfoImpl(
    std::shared_ptr<OHOS::NWeb::NWebNativeEmbedParamDataInfo>
        nweb_native_embed_param_data_info)
...
ArkWebString ArkWebNativeEmbedParamDataInfoImpl::GetEmbedId() {
  return ArkWebStringClassToStruct(
      nweb_native_embed_param_data_info_->GetEmbedId());
}
...
ArkWebNativeEmbedParamDataInfoImpl::GetParamItems() {
  return ArkWebNativeEmbedParamItemVectorClassToStruct(
      nweb_native_embed_param_data_info_->GetParamItems());
}
