...
#ifndef ARK_WEB_ADSBLOCK_MANAGER_IMPL_H_
#define ARK_WEB_ADSBLOCK_MANAGER_IMPL_H_
#pragma once
...
class ArkWebAdsBlockManagerImpl : public ArkWebAdsBlockManager {
 ...
 public:
  ...
  void AddAdsBlockDisallowedList(
      const ArkWebStringVector& domainSuffixes) override;
 ...
 private:
  std::shared_ptr<OHOS::NWeb::NWebAdsBlockManager> nweb_adsblock_manager_;
};

}  // namespace OHOS::ArkWeb

#endif  // ARK_WEB_ADSBLOCK_MANAGER_IMPL_H_
