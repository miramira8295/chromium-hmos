...
ArkWebNativeEmbedMouseEventImpl::ArkWebNativeEmbedMouseEventImpl(
    std::shared_ptr<OHOS::NWeb::NWebNativeEmbedMouseEvent>
        nweb_native_embed_mouse_event)
...
ArkWebString ArkWebNativeEmbedMouseEventImpl::GetEmbedId() {
  return ArkWebStringClassToStruct(
      nweb_native_embed_mouse_event_->GetEmbedId());
}

ArkWebRefPtr<ArkWebMouseEventResult>
ArkWebNativeEmbedMouseEventImpl::GetResult() {
  std::shared_ptr<OHOS::NWeb::NWebMouseEventResult> result =
      nweb_native_embed_mouse_event_->GetResult();
