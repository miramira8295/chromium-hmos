...
class ArkWebCookieManagerImpl : public ArkWebCookieManager {
 ...
 public:
   ...
   */
  int SetCookie(const ArkWebString& url,
   ...
   */
  void SetCookie(const ArkWebString& url,
                 const ArkWebString& value,
   ...
   */
  ArkWebString ReturnCookie(const ArkWebString& url,
                            bool& is_valid,
                            bool incognito_mode) override;
   ...
   * @param callback a callback to be executed when the cookie has been set.
   */
  void ConfigCookie(const ArkWebString& url,
                    const ArkWebString& value,
  ...
  int SetCookieSync(const ArkWebString& url,
                    const ArkWebString& value,
                    bool incognitoMode,
                    bool includeHttpOnly) override;

  void SetCookieAsync(const ArkWebString& url,
                      const ArkWebString& value,
                      bool incognitoMode,
