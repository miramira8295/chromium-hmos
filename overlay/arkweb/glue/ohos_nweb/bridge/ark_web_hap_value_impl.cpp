...
ArkWebHapValueImpl::ArkWebHapValueImpl(
...
ArkWebUint8Vector ArkWebHapValueImpl::GetBinary() {
  return ArkWebBasicVectorClassToStruct<uint8_t, ArkWebUint8Vector>(
      nweb_hap_value_->GetBinary());
}

void ArkWebHapValueImpl::SetBinary(const ArkWebUint8Vector& value) {
  nweb_hap_value_->SetBinary(
      ArkWebBasicVectorStructToClass<uint8_t, ArkWebUint8Vector>(value));
}

ArkWebBooleanVector ArkWebHapValueImpl::GetBoolArray() {
  return ArkWebBasicVectorClassToStruct<bool, ArkWebBooleanVector>(
      nweb_hap_value_->GetBoolArray());
}

void ArkWebHapValueImpl::SetBoolArray(const ArkWebBooleanVector& value) {
  nweb_hap_value_->SetBoolArray(
      ArkWebBasicVectorStructToClass<bool, ArkWebBooleanVector>(value));
}

ArkWebInt64Vector ArkWebHapValueImpl::GetInt64Array() {
  return ArkWebBasicVectorClassToStruct<int64_t, ArkWebInt64Vector>(
      nweb_hap_value_->GetInt64Array());
}

void ArkWebHapValueImpl::SetInt64Array(const ArkWebInt64Vector& value) {
  nweb_hap_value_->SetInt64Array(
      ArkWebBasicVectorStructToClass<int64_t, ArkWebInt64Vector>(value));
}

ArkWebDoubleVector ArkWebHapValueImpl::GetDoubleArray() {
  return ArkWebBasicVectorClassToStruct<double, ArkWebDoubleVector>(
      nweb_hap_value_->GetDoubleArray());
}

void ArkWebHapValueImpl::SetDoubleArray(const ArkWebDoubleVector& value) {
  nweb_hap_value_->SetDoubleArray(
      ArkWebBasicVectorStructToClass<double, ArkWebDoubleVector>(value));
}
