...
class NWebPrintAttributesAdapterWrapper
    : public OHOS::NWeb::NWebPrintAttributesAdapter {
 public:
  explicit NWebPrintAttributesAdapterWrapper(
      ArkWebRefPtr<ArkWebPrintAttributesAdapter> ref)
      : ref_(ref) {}
