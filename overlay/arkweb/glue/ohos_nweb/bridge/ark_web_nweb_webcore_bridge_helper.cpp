...
void ArkWebNWebWebcoreBridgeHelper::Init() {
  ...
  memberCheckFunc_ = reinterpret_cast<ArkWebMemberCheckFunc>(
      LoadFuncSymbol("ark_web_nweb_webview_check_func_static", false));
}
...
ARK_WEB_EXPORT
void* ark_web_nweb_webcore_check_func_static(ArkWebBridgeType bridgeType,
  ...
  return OHOS::ArkWeb::ArkWebNWebWebcoreBridgeHelper::GetInstance()
