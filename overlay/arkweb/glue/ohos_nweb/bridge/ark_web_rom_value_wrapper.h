...
#ifndef ARK_WEB_ROM_VALUE_WRAPPER_H_
#define ARK_WEB_ROM_VALUE_WRAPPER_H_
#pragma once

#include <vector>

#include "include/nweb_rom_value.h"
...
class ArkWebRomValueWrapper : public OHOS::NWeb::NWebRomValue {
 public:
  ArkWebRomValueWrapper(ArkWebRefPtr<ArkWebRomValue> ark_web_rom_value);
  ~ArkWebRomValueWrapper() = default;

  ArkWebRomValueType GetType() override;

  void SetType(ArkWebRomValueType type) override;
  ...
  GetDictValue() override;

  std::vector<std::shared_ptr<OHOS::NWeb::NWebRomValue>> GetListValue()
      override;

  std::shared_ptr<OHOS::NWeb::NWebRomValue> NewChildValue() override;
 ...
 private:
  ArkWebRefPtr<ArkWebRomValue> ark_web_rom_value_;
};

}  // namespace OHOS::ArkWeb

#endif  // ARK_WEB_ROM_VALUE_WRAPPER_H_
