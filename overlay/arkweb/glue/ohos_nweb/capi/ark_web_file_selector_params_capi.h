...
#ifndef ARK_WEB_FILE_SELECTOR_PARAMS_CAPI_H_
#define ARK_WEB_FILE_SELECTOR_PARAMS_CAPI_H_
#pragma once
...
typedef struct _ark_web_file_selector_params_t {
  ...
  const ArkWebStringVector(ARK_WEB_CALLBACK* mime_type)(
      struct _ark_web_file_selector_params_t* self);
...
#endif  // ARK_WEB_FILE_SELECTOR_PARAMS_CAPI_H_
