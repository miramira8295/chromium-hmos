...
#ifndef ARK_WEB_ENGINE_INIT_ARGS_CAPI_H_
#define ARK_WEB_ENGINE_INIT_ARGS_CAPI_H_
#pragma once
...
typedef struct _ark_web_engine_init_args_t {
  ...
  ArkWebString(ARK_WEB_CALLBACK* get_shared_render_process_token)(
      struct _ark_web_engine_init_args_t* self);
...
#endif  // ARK_WEB_ENGINE_INIT_ARGS_CAPI_H_
