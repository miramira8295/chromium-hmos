...
class ArkWebEngine : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkWebNWeb> CreateNWeb(
      ArkWebRefPtr<ArkWebNWebCreateInfo> create_info) = 0;
  ...
  virtual void InitializeWebEngine(
      ArkWebRefPtr<ArkWebEngineInitArgs> init_args) = 0;

  /*--ark web()--*/
  virtual void PrepareForPageLoad(const ArkWebString& url,
                                  bool preconnectable,
  ...
  /*--ark web()--*/
  virtual void ClearPrefetchedResource(
      const ArkWebStringVector& cache_key_list) = 0;
   ...
   * @Input proxy_scheme_filters: The proxy scheme filters for construct proxy
   * rule.
   ...
   */
  /*--ark web()--*/
  virtual void RemoveProxyOverride(
      ArkWebRefPtr<ArkWebProxyChangedCallback> callback) = 0;
  ...
  /*--ark web()--*/
  virtual void SetUserAgentForHosts(const ArkWebString& userAgent,
                                    const ArkWebStringVector& hosts) = 0;

  /*--ark web()--*/
  virtual void SetWebDebuggingAccessAndPort(bool isEnableDebug,
                                            int32_t port) = 0;
  ...
  /*--ark web()--*/
  virtual ArkWebString CheckBlankOptEnable(const ArkWebString& url,
                                           int32_t nweb_id) = 0;
