...
#ifndef ARK_WEB_ROM_VALUE_H_
#define ARK_WEB_ROM_VALUE_H_
#pragma once
...
class ArkWebRomValue : public virtual ArkWebBaseRefCounted {
 public:
  /*--ark web()--*/
  ...
  /*--ark web()--*/
  virtual ArkWebRomValueMap GetDictValue() = 0;

  /*--ark web()--*/
  virtual ArkWebRomValueVector GetListValue() = 0;

  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkWebRomValue> NewChildValue() = 0;
