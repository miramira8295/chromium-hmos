...
class ArkWebNWeb : public virtual ArkWebBaseRefCounted {
 public:
  ...
  /**
   * @Description: Get the accessibility visibility of the accessibility node by
   * its accessibility id in the browser.
  ...
  /**
   * @Description: Set the params when the scale of WebView changed by pinch
   * gestrue.
   *
  ...
  virtual bool SendKeyboardEvent(
      ArkWebRefPtr<ArkWebKeyboardEvent> keyboardEvent) = 0;

  /**
   * @Description: Execute an accessibility action on an accessibility node in
   * the browser.
   ...
   */
  /*--ark web()--*/
  virtual bool PerformActionV2(int64_t accessibilityId,
                               uint32_t action,
                               const ArkWebStringMap& actionArguments) = 0;
   ...
   * @Input scriptItems: The injected JavaScript code is stored in
   * lexicographical order.
   * @Input scriptItemsByOrder: The injected JavaScript code is stored in the
   * order of the injection array.
   */
  /*--ark web()--*/
  ...
  /**
   * @Description: Get the bounding rectangle of the accessibility node of the
   * given id.
   * @Input accessibilityId: The id of the accessibility node.
   ...
   */
  /*--ark web()--*/
  virtual bool WebSendMouseWheelEventV2(double x,
                                        double y,
                                        double delta_x,
                                        double delta_y,
   ...
   * @param borderRadiusTopLeft: Radius value of the rounded corner in the
   * top-left of the webpage.
   * @param borderRadiusTopRight: Radius value of the rounded corner in the
   * top-right of the webpage.
   * @param borderRadiusBottomLeft: Radius value of the rounded corner in the
   * bottom-left of the webpage.
   * @param borderRadiusBottomRight: Radius value of the rounded corner in the
   * bottom-right of the webpage.
   */
  /*--ark web()--*/
   ...
   * @param x horizontal location of coordinate.
   * @param y vertical location of coordinate.
   * @param isHoverEnter whether the accessibility hover event is a hover enter
   * event.
   */
  /*--ark web()--*/
  virtual void SendAccessibilityHoverEventV2(int32_t x,
                                             int32_t y,
                                             bool isHoverEnter) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void RegisterNativeJavaScriptProxy(
   ...
   * @return The accessibility id of the accessibility node with Same-layer
   * rendering.
   */
  /*--ark web()--*/
  virtual int64_t GetWebAccessibilityIdByHtmlElementId(
      const ArkWebString& htmlElementId) = 0;
   ...
   */
  /*--ark web()--*/
  virtual int32_t GetBlanklessInfoWithKey(const ArkWebString& key,
                                          double* similarity,
   ...
   */
  /*--ark web()--*/
  virtual int32_t SetBlanklessLoadingWithKey(const ArkWebString& key,
                                             bool isStart) = 0;
   ...
   * @param touchHandleExist The state of the touch handle, Which is true if the
   * touch handle exists.
   */
  /*--ark web()--*/
   ...
   * @param avoidHeight The height value of the visible viewport avoidance.
   * Unit: px.
   */
  /*--ark web()--*/
  ...
  /**
   * @brief Set whether enable the error page. onOverrideErrorPage will be
   * triggered when the page error.
   *
   ...
   */
  /*--ark web()--*/
  virtual void CallH5FunctionV2(int32_t routing_id,
   ...
   */
  /*--ark web()--*/
  virtual void PostPortMessageV2(const ArkWebString& portHandle,
                                 ArkWebRefPtr<ArkWebRomValue> data) = 0;
   ...
   */
  /*--ark web()--*/
  virtual ArkWebRefPtr<ArkWebPrintDocumentAdapterAdapter>
  CreateWebPrintDocumentAdapterV2(const ArkWebString& job_name) = 0;

  /**
   * @brief Handle stylus touch press event.
   * @param stylus_touch_point_info The stylus touch point information object
   * containing all necessary data (including id, coordinates, and stylus
   * properties).
   * @param from_overlay Indicates whether the event comes from an overlay
   * layer.
   */
  /*--ark web()--*/
   ...
   * @param stylus_touch_point_infos The collection of stylus touch point
   * information containing all necessary data (including multiple points with
   * their ids, coordinates, and properties).
   * @param from_overlay Indicates whether the event comes from an overlay
   * layer.
   */
  /*--ark web()--*/
   ...
   * @param ignoreCacheControlNoStore:  true if ignoring Cache-Control:
   * no-store.
   */
  /*--ark web()--*/
  virtual void PrefetchPageV2(const ArkWebString& url,
