...
class ArkWebDragData : public virtual ArkWebBaseRefCounted {
 public:
   ...
   */
  /*--ark web()--*/
  virtual bool GetPixelMapSetting(const void** data,
                                  size_t& len,
                                  int& width,
                                  int& height) = 0;
   ...
   */
  /*--ark web()--*/
  virtual bool SetPixelMapSetting(const void* data,
                                  size_t len,
                                  int width,
                                  int height) = 0;
   ...
   * @Return: Returns an drag style, true is drag a new style, otherwise, drag a
   * old style.
   */
  /*--ark web()--*/
