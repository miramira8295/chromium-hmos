...
#ifndef ARK_WEB_ROM_VALUE_VECTOR_CTOCPP_H_
#define ARK_WEB_ROM_VALUE_VECTOR_CTOCPP_H_
#pragma once
...
void ArkWebRomValueMapStructRelease(ArkWebRomValueMap& struct_value);
...
void ArkWebRomValueVectorStructRelease(ArkWebRomValueVector& struct_value);

}  // namespace OHOS::ArkWeb

#endif  // ARK_WEB_ROM_VALUE_VECTOR_CTOCPP_H_
